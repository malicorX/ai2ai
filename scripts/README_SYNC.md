...
.\scripts\sync_to_sparkies.ps1 push

# Pull latest from GitHub and sync to sparkies
.\scripts\sync_to_sparkies.ps1 pull

# Do both (default)
.\scripts\sync_to_sparkies.ps1 both
```
...
**Files out of sync:**
- Run `.\scripts\sync_to_sparkies.ps1 push` to sync everything
