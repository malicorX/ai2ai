...
# 
# Usage: 
#   .\scripts\sync_to_sparkies.ps1 push    # Push local changes to GitHub, then sync to sparkies
#   .\scripts\sync_to_sparkies.ps1 pull    # Pull changes from GitHub, then sync to sparkies  
#   .\scripts\sync_to_sparkies.ps1 both    # Do both (default)
