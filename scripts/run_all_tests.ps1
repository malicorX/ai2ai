...
try {
    ...
    Write-Host "Test suite: verifier_unit -> quick_test -> test_run -> test_proposer_review -> test_proposer_review_reject" -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "--- 3/5 test_run ---" -ForegroundColor Yellow
