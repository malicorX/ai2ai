...
# Get job details
if (-not $JobId) {
    Write-Host "Usage: .\scripts\testing\test_run_report.ps1 -JobId <job_id>" -ForegroundColor Red
    Write-Host "Or: .\scripts\testing\test_run_report.ps1 -JobId <job_id> -BackendUrl http://sparky1:8000" -ForegroundColor Gray
    exit 1
}
